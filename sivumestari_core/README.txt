Sivumestari Core
=============
This is the magical core of the Sivumestari framework. It helps to package the
entire distribution and provides some generally useful features that other
parts of Sivumestari can leverage.
...
* Provides defaults about the Sivumestari App Server for use by Apps.module
* Special handling of site breadcrumb to append current page title
* Installation profile specific code for cleaner profiles based on Sivumestari
