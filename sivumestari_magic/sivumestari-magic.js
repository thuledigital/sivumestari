(function ($) {
 ...
 Drupal.behaviors.sivumestariMagic = {
   attach: function (context, settings) {

     /**
      * Title Hax for Sivumestari
      *
...
(function ($) {
   ...
   */
  Drupal.behaviors.sivumestariMagicAutosubmit = {
    attach: function (context, settings) {
      ...
      $('.field-widget-link-field input:text', context).addClass('sivumestari-textfield-autosubmit').addClass('ctools-auto-submit-exclude');

      // Handle title fields.
      var timer;
      $('.sivumestari-textfield-autosubmit', context).bind('keyup keydown blur', function (e) {
        var $element;
      ...
      $('.sivumestari-autocomplete-autosubmit', context).blur(function (e) {
        triggerSubmit.call(e.target.form);
      });

      // Handle textarea fields.
      $('.sivumestari-textarea-autosubmit', context).bind('keyup keydown blur', function (e) {
